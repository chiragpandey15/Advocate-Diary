...
class _LoginState extends State<Login> {
  ...
  Future<void>sendToServer(String accessToken)async{
    try{
      ...
      /*********************************** */
      Toast.show(data.toString(),context, duration: Toast.LENGTH_LONG,gravity:  Toast.CENTER);    
      ...
      if(response.statusCode==200)
      {
        ...
        else
        {
          ...
          Toast.show("RES issue",context, duration: Toast.LENGTH_LONG,gravity:  Toast.CENTER);    
        }
      }
      else
      {
        // Toast.show("Something went to wrong. Please try after some time",context, duration: Toast.LENGTH_LONG,gravity:  Toast.CENTER);  
        Toast.show("Status code issue",context, duration: Toast.LENGTH_LONG,gravity:  Toast.CENTER);    
      }

    }catch(e){
      print(e);
      // Toast.show("Something went to wrong. Please try after some time",context, duration: Toast.LENGTH_LONG,gravity:  Toast.CENTER);  
      Toast.show("Internet or other issue",context, duration: Toast.LENGTH_LONG,gravity:  Toast.CENTER);    
    }finally{
      setState(() {
        wait=false;
      });
