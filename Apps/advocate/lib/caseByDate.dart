    ...
    return Scaffold(
      ...
      ListView.builder(
        ...
        itemBuilder: (context,index){
          return Card(
            color: casesByDate[index].dispose==1?Colors.purple[200]:Colors.white,
            child: InkWell(
              onTap: (){
                Navigator.pushNamed(context, '/perticularCase',arguments: {'case':casesByDate[index],'dispose': casesByDate[index].dispose==1?true:false}).then((s){
                  getCasesByDate(date);
                });
              },
              child:Column(
                  ...
                  Row(
                    ...
                    children:<Widget>[
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color:casesByDate[index].dispose==0?Colors.grey:Colors.white,
                          fontSize: 18,
                        ),
                      ),
                    ]
