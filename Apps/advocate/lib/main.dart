...
import 'package:advocate/dispose.dart';
    ...
    return Scaffold(
      ...
      ListView.builder(
        ...
        itemBuilder: (context,index){
          return Card(
            color: todaysCase[index].dispose==1?Colors.purple[200]:Colors.white,
            child: InkWell(
              onTap: (){
                  ...
                  Row(
                    ...
                    children:<Widget>[
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color:todaysCase[index].dispose==1?Colors.white:Colors.grey,
                          fontSize: 18,
                        ),
                      ),
                    ]
      ...
      floatingActionButton: FloatingActionButton(
                              onPressed: (){
                                Navigator.pushNamed(context, '/addCase',).then((value){
                                  getTodaysList();
                                });
                              },
        ...
        child: Column(
          children: [
            ...
            Card(
              child: InkWell(
                onTap:(){
                  Navigator.pushNamed(context, '/dispose',);
                },
                child:Row(
                    children: <Widget>[
                      Icon(
